...
export function Smell() {
  return (
    <section className="section" id="v3-smell">
      ...
      <FlawItem severity="gate" tag="GATE-2" title="No cross-app imports">
        <code>npx depcruise apps/api --config .dependency-cruiser.js</code> with a rule that
        forbids <code>apps/*</code> importing anything under a sibling <code>apps/*</code>. Apps
        talk via queue only.
      </FlawItem>
      <FlawItem severity="gate" tag="GATE-3" title="Domain code doesn't know AWS/GCP/Azure exist">
        <code>rg &quot;from &apos;@aws-sdk|@google-cloud|@azure/&quot; apps packages -g &apos;!packages/cloud/**&apos; &amp;&amp; exit 1</code>.
      </FlawItem>
      <FlawItem severity="gate" tag="GATE-4" title="No circular deps">
        <code>npx madge --circular packages apps</code>. First circular import is where the split
        starts leaking.
      </FlawItem>
      ...
      <FlawItem severity="p1" tag="GATE-6" title="No process.env outside config.js">
        <code>rg &quot;process\\.env\\.&quot; apps -g &apos;!**/config.js&apos; -g &apos;!**/*.test.js&apos;</code>. Every
        service reads env exactly once at boot.
      </FlawItem>
      <FlawItem severity="p1" tag="GATE-7" title="No console.log in shipped code">
        <code>rg &quot;console\\.(log|error|warn)&quot; apps packages -g &apos;!**/*.test.js&apos;</code>. Use the
