...
└─ src/
   ...
   └─ sse/
      ...
      <h3>Key sequence · POST /api/runs</h3>
      <Diagram ariaLabel="api create-run sequence">
{` client         handler       validate   db          objectStore   queue
   │              │              │        │              │           │
   │─ POST /runs ▶│              │        │              │           │
   │              │─ auth req    │        │              │           │
   │              │─ validate ──▶│        │              │           │
   ...
   │              │─ presignPut × N ────────────────────▶│           │
   │              │  ◀── urls             │              │           │
   │              │─ publish runs.requested (via outbox)             │
   │  ◀── 202 { runId, uploads }`}
      </Diagram>
