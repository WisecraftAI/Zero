...
| **Folder** | Path on disk. Open this in the editor. | `apps/api/` |
...
|-----------|--------|-------------|--------------|--------|
| HTTP API | `apps/api/` | `@zero/api` | `/zero-api` | [api.md](./api.md) |
| Orchestrator worker | `apps/orchestrator/` | `@zero/orchestrator` | `/zero-orchestrator` | [orchestrator.md](./orchestrator.md) |
| Playwright executor | `apps/executor/` | `@zero/executor` | `/zero-executor` | [executor.md](./executor.md) |
