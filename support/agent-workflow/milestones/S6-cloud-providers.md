...
- [x] Azure adapter entrypoint exists
- [x] Vercel adapter entrypoint exists
- [x] Conformance suite directory has at least one spec file
- [x] `ZERO_CLOUD=local` still boots without vendor SDKs
- [x] `npm run workflow:verify -- --milestone S6` exits 0
