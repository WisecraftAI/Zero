...
module.exports = function registerKeyRoutes(app, ctx) {
   ...
   */
  app.get("/api/keys", ctx.rateLimiters.apiKey, (req, res) => {
   ...
   *     tags: [API Keys]
   */
  app.post("/api/keys", ctx.rateLimiters.apiKey, async (req, res) => {
   ...
   *     tags: [API Keys]
   */
  app.delete("/api/keys/:keyId", ctx.rateLimiters.apiKey, (req, res) => {
   ...
   *     tags: [API Keys]
   */
  app.post("/api/keys/:keyId/test", ctx.rateLimiters.apiKey, async (req, res) => {
    const { keyId } = req.params;
   ...
   *     tags: [API Keys]
   */
  app.post("/api/keys/validate", ctx.rateLimiters.apiKey, (req, res) => {
